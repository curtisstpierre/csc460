/*
 * http://www.irobot.com/images/consumer/hacker/Roomba_SCI_Spec_Manual.pdf page 4
 * Transmitter.pde
 *
...
void setup()
{
  ...
  snprintf((char*)packet.payload.message.messagecontent, sizeof(packet.payload.message.messagecontent), "Turtles in the dark.");
